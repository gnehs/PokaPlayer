...
function HTML_getHeader(title) {
    return `<div class="mdui-container-fluid mdui-valign mdui-typo" style="height: 150px;background-image:url(/og/og.png);background-size: cover;background-color: #3f51b5;" id="header-wrapper">
