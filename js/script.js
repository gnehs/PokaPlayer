...
function HTML_getHeader(title) {
    return `<div class="mdui-container-fluid mdui-valign mdui-typo mdui-color-theme" style="height: 150px;background-image:url(/og/og.png);background-size: cover;" id="header-wrapper">
